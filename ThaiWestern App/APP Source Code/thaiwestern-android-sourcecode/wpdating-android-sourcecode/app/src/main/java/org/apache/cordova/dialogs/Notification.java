...
public class Notification extends CordovaPlugin {
    ...
    private static final String TAG = "wpdating"+"Notification";
            ...
            public void run() {
                ...
                if (buttonLabels.length() > 0) {
                    try {
                        ...
                        Log.d(TAG,"JSONException on first button.");
                    }
                }
                ...
                if (buttonLabels.length() > 1) {
                    try {
                        ...
                        Log.d(TAG,"JSONException on second button.");
                    }
                }
                ...
                if (buttonLabels.length() > 2) {
                    try {
                        ...
                        Log.d(TAG,"JSONException on third button.");
                    }
                }
                dlg.setOnCancelListener(new AlertDialog.OnCancelListener() {
                    public void onCancel(DialogInterface dialog)
                            ...
                            new AlertDialog.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    try {
                                        ...
                                        Log.d(TAG,"JSONException on first button.", e);
                                    }
                            ...
                            new AlertDialog.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    try {
                                        ...
                                        Log.d(TAG,"JSONException on second button.", e);
                                    }
                                    callbackContext.sendPluginResult(new PluginResult(PluginResult.Status.OK, result));
                                }
                            });
                            ...
                            new AlertDialog.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    try {
                                        ...
                                        Log.d(TAG,"JSONException on third button.", e);
                                    }
                                    callbackContext.sendPluginResult(new PluginResult(PluginResult.Status.OK, result));
                                }
                            });
