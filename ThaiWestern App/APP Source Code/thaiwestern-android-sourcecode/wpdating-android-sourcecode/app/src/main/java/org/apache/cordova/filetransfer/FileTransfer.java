...
public class FileTransfer extends CordovaPlugin {
    ...
    private static final String TAG = "wpdating"+"FileTransfer";
    ...
    private void upload(final String source, final String target, JSONArray args, CallbackContext callbackContext) throws JSONException {
        Log.d(TAG, "upload " + source + " to " +  target);
        ...
        Log.d(TAG, "chunkedMode: " + chunkedMode);
        ...
        if (uriType != CordovaResourceApi.URI_TYPE_HTTP && !useHttps) {
            ...
            Log.e(TAG, "Unsupported URI: " + targetUri);
        ...
        cordova.getThreadPool().execute(new Runnable() {
            public void run() {
                ...
                try {
                    ...
                    Log.d(TAG, "Content Length: " + fixedLength);
                    ...
                    if (useChunkedMode) {
                        ...
                        if (useHttps) {
                            Log.w(TAG, "setFixedLengthStreamingMode could cause OutOfMemoryException - switch to chunkedMode=true to avoid it if this is an issue.");
                        }
                    }
                    ...
                    try {
                        ...
                        while (bytesRead > 0) {
                            ...
                            if (totalBytes > prevBytesRead + 102400) {
                                ...
                                Log.d(TAG, "Uploaded " + totalBytes + " of " + fixedLength + " bytes");
                            }
                    ...
                    Log.d(TAG, "Sent " + totalBytes + " of " + fixedLength);
                    ...
                    Log.d(TAG, responseString.substring(0, Math.min(256, responseString.length())));
                    ...
                    Log.e(TAG, error.toString(), e);
                    Log.e(TAG, "Failed after uploading " + totalBytes + " of " + fixedLength + " bytes.");
                    context.sendPluginResult(new PluginResult(PluginResult.Status.IO_EXCEPTION, error));
                } catch (JSONException e) {
                    Log.e(TAG, e.getMessage(), e);
    ...
    private static JSONObject createFileTransferError(int errorCode, String source, String target, URLConnection connection, Throwable throwable) {
        ...
        if (connection != null) {
            ...
            // IOException can leave connection object in a bad state, so catch all exceptions.
                ...
                Log.w(TAG, "Error getting HTTP status code from connection.", e);
            }
        }
    ...
    private void download(final String source, final String target, JSONArray args, CallbackContext callbackContext) throws JSONException {
        Log.d(TAG, "download " + source + " to " +  target);
        ...
        if (uriType == CordovaResourceApi.URI_TYPE_UNKNOWN) {
            JSONObject error = createFileTransferError(INVALID_URL_ERR, source, target, null, 0, null);
            Log.e(TAG, "Unsupported URI: " + sourceUri);
            callbackContext.sendPluginResult(new PluginResult(PluginResult.Status.IO_EXCEPTION, error));
            return;
        }
        ...
        if (!Boolean.TRUE.equals(shouldAllowRequest)) {
            Log.w(TAG, "Source URL is not in white list: '" + source + "'");
        ...
        cordova.getThreadPool().execute(new Runnable() {
            public void run() {
                ...
                try {
                    ...
                    Log.d(TAG, "Download file:" + sourceUri);
                    ...
                    if (isLocalTransfer) {
                        ...
                        if (connection.getResponseCode() == HttpURLConnection.HTTP_NOT_MODIFIED) {
                            ...
                            Log.d(TAG, "Resource not modified: " + source);
                    ...
                    if (!cached) {
                        ...
                        if (filePlugin != null) {
                            ...
                            if (fileEntry != null) {
                                ...
                                Log.e(TAG, "File plugin cannot represent download path");
                                result = new PluginResult(PluginResult.Status.IO_EXCEPTION, error);
                            }
                        } else {
                            Log.e(TAG, "File plugin not found; cannot save downloaded file");
                    ...
                    synchronized (context) {
                        ...
                        if (context.connection != null) {
                            try {
                                ...
                                Log.e(TAG, "CB-8431 Catch workaround for fatal exception", e);
                            }
                        }
                    }
                }
