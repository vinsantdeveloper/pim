...
public class AudioPlayer implements OnCompletionListener, OnPreparedListener, OnErrorListener {
    ...
    private static final String TAG ="wpdating"+ "AudioPlayer";
...
//    private static int MEDIA_ERR_NONE_SUPPORTED = 4;
    ...
    public void moveFile(String file) {
        ...
        if (size == 1) {
            ...
            if (!f.renameTo(new File(file))) Log.e(TAG, "FAILED " + logMsg);
        }
    ...
    public void pausePlaying() {
        ...
        if (this.state == STATE.MEDIA_RUNNING && this.player != null) {
            ...
            Log.d(TAG, "AudioPlayer Error: pausePlaying() called during invalid state: " + this.state.ordinal());
    ...
    public void stopPlaying() {
        if ((this.state == STATE.MEDIA_RUNNING) || (this.state == STATE.MEDIA_PAUSED)) {
            ...
            Log.d(TAG, "stopPlaying is calling stopped");
            this.setState(STATE.MEDIA_STOPPED);
        }
        else {
            Log.d(TAG, "AudioPlayer Error: stopPlaying() called during invalid state: " + this.state.ordinal());
            sendErrorStatus(MEDIA_ERR_NONE_ACTIVE);
        }
    }
    ...
    public void onCompletion(MediaPlayer player) {
        Log.d(TAG, "on completion is calling stopped");
        this.setState(STATE.MEDIA_STOPPED);
    }
    ...
    public void setVolume(float volume) {
        if (this.player != null) {
            ...
            Log.d(TAG, "AudioPlayer Error: Cannot set volume until the audio file is initialized.");
            sendErrorStatus(MEDIA_ERR_NONE_ACTIVE);
        }
    }
        ...
        if (playMode()) {
            switch (this.state) {
                ...
                case MEDIA_LOADING:
                    ...
                    Log.d(TAG, "AudioPlayer Loading: startPlaying() called during media preparation: " + STATE.MEDIA_STARTING.ordinal());
                    this.prepareOnly = false;
                    return false;
                case MEDIA_STARTING:
                case MEDIA_RUNNING:
