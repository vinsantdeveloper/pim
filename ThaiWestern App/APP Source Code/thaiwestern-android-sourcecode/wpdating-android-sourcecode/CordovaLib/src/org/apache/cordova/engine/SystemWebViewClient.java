...
public class SystemWebViewClient extends WebViewClient {
    ...
    private static final String TAG = "wpdating"+"SystemWebViewClient";
    ...
    public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
        ...
        Log.d(TAG, String.format("CordovaWebViewClient.onReceivedError: Error code=%s Description=%s URL=%s", errorCode, description, failingUrl));
