...
public class SystemWebChromeClient extends WebChromeClient {
    ...
    private static final String TAG = "wpdating" + "SystemWebChromeClient";
    ...
    private static OnConsoleMessageListener listener;

    public static void setOnConsoleMessage(OnConsoleMessageListener listener) {
        SystemWebChromeClient.listener = listener;
    }
    ...
    public boolean onJsConfirm(WebView view, String url, String message, final JsResult result) {
        Log.d("wpdating", "onJsConfirm(), url = " + url + ", message = " + message);
    ...
    public boolean onJsPrompt(WebView view, String origin, String message, String defaultValue, final JsPromptResult result) {
        ...
        Log.d(TAG, "onJsPrompt(), origin = " + origin + ", message = " + message + ", default value = " + defaultValue);
    ...
    public void onExceededDatabaseQuota(String url, String databaseIdentifier, long currentQuota, long estimatedSize,
        ...
        Log.d(TAG, String.format("onExceededDatabaseQuota estimatedSize: %d  currentQuota: %d  totalUsedQuota: %d", estimatedSize, currentQuota, totalUsedQuota));
    ...
    public boolean onConsoleMessage(ConsoleMessage consoleMessage) {
        ...
        if (consoleMessage.message() != null)
            Log.d(TAG, String.format("%s: Line %d : %s", consoleMessage.sourceId(), consoleMessage.lineNumber(), consoleMessage.message()));
    ...
    public boolean onShowFileChooser(WebView webView, final ValueCallback<Uri[]> filePathsCallback, final WebChromeClient.FileChooserParams fileChooserParams) {
        ...
        try {
            ...
            Log.w(TAG, "No activity found to handle file chooser intent = " + e.toString());
