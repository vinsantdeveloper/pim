...
public class CoreAndroid extends CordovaPlugin {
    ...
    protected static final String TAG = "wpdating"+"CordovaApp";
    ...
    public void overrideBackbutton(boolean override) {
        Log.d("App", "WARNING: Back Button Default Behavior will be overridden.  The backbutton event will be fired!");
    ...
    public void overrideButton(String button, boolean override) {
        Log.d("App", "WARNING: Volume Button Default Behavior will be overridden.  The volume event will be fired!");
